...
Long tStop test::
    ...
    bsub -M 10000 -R "rusage[mem=10000]" smt run long_tstop_double_stim_onebranch_several_stimulations.param -r "Several stims across one branch pupolated with spines. Using 10 Gb" -t "onebranch"
